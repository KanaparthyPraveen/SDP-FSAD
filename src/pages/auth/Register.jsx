    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            const result = register({
                ...
                department: form.department, rollNo: form.rollNo, year: form.year,
            });
            if (result.success) {
    ...
    return (
        <div>
            <div className="text-center mb-8">
                ...
                <p className="text-sm text-gray-500">Join PlaceIQ and start your placement journey</p>
            </div>
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[#0a0a0a] p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label className="block text-xs font-medium text-gray-400 mb-2">Confirm</label>
                            <div className="relative">
                                <Lock size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" />
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <BookOpen size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-medium text-gray-400 mb-2">Roll No</label>
                            <div className="relative">
